                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="">
                            ...
                            @method('PUT')
                            <div class="">
                                <label class="small mb-1" for="inputFullName">Nama Vendor</label>
                                <input class="form-control" id="inputFullName" type="text" name="name" placeholder="Masukan nama lengkap Anda" value="{{ Auth::user()->name }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <button class="btn" style="background-color:#0046BF; color:white;" type="submit">Save changes</button>
                        </form>
                    </div>
                </div>
            </div>
